    ...
    >
      ...
      <div className="w-[300px] h-[320px] bg-transparent  group perspective shadow-2xl">
        <div className="relative preserve-3d group-hover:my-rotate-y-180 w-full h-full duration-1000">
          ...
          <div className="absolute my-rotate-y-180 w-full backface-hidden h-full bg-gray-100 overflow-hidden ">
            <div className="text-center flex flex-col items-center h-full text-gray-800 px-2 pb-24 p-5 bg-gradient-to-tr ">
      ...
      <div className="w-[300px] h-[320px] bg-transparent group perspective">
        <div className="relative preserve-3d group-hover:my-rotate-y-180 w-full h-full duration-1000">
          ...
          <div className="absolute my-rotate-y-180 w-full backface-hidden h-full bg-gray-100 overflow-hidden ">
            <div className="bg-blue-500 text-center flex flex-col items-center h-full text-gray-800 px-2 pb-24 p-2">
