      ...
      <section className="text-white  md:grid p-2 md:grid-cols-[1fr_2fr] md:min-h-[622px]  mx-auto">
        ...
        <section className="px-4 py-10 text-center rounded-b-xl bg-blue md:grid md:place-content-center md:px-10 ">
          ...
          <p className="mt-4 md:mt-10 md:relative md:z-20 ">
            Apasionado con un enfoque creativo y una fascinación por el mundo
            del diseño y la tecnología. A través de mi carrera, he tenido el
            privilegio de trabajar en diversos proyectos donde he podido
            combinar mis habilidades artísticas y mi experiencia técnica para
            crear soluciones únicas y atractivas.
          </p>

          <div className="hover:animate-pulse z-20 flex justify-center py-4 font-bold">
            <button
